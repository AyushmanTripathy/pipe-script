    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$8, 60, 2, 1287);
    			attr_dev(main, "class", "svelte-14s77of");
    			add_location(main, file$8, 59, 0, 1278);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			a = element("a");
    			t5 = text$1("check the repo");
    			t6 = space();
    			p1 = element("p");
    			t7 = text$1("try it out!");
    			t8 = space();
    			code = element("code");
    			t9 = text$1("npm install -g pipescript-dev-kit");
    			this.h();
    		},
    		l: function claim(nodes) {
    			main = claim_element(nodes, "MAIN", { class: true });
    			...
    			t5 = claim_text(a_nodes, "check the repo");
    			a_nodes.forEach(detach_dev);
    			t6 = claim_space(main_nodes);
    			p1 = claim_element(main_nodes, "P", {});
    			var p1_nodes = children(p1);
    			t7 = claim_text(p1_nodes, "try it out!");
    			p1_nodes.forEach(detach_dev);
    			t8 = claim_space(main_nodes);
    			code = claim_element(main_nodes, "CODE", {});
    			var code_nodes = children(code);
    			t9 = claim_text(code_nodes, "npm install -g pipescript-dev-kit");
    		...
    		h: function hydrate() {
    			...
    			add_location(a, file$4, 8, 2, 171);
    			add_location(p1, file$4, 9, 2, 250);
    			add_location(code, file$4, 10, 2, 271);
