...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 60, 2, 1232);
    			attr_dev(main, "class", "svelte-1vbfj1z");
    			add_location(main, file$2, 59, 0, 1223);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file, 7, 2, 128);
    			attr_dev(main, "class", "svelte-15ojgx8");
    			add_location(main, file, 6, 0, 119);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Editor, Console, code });
